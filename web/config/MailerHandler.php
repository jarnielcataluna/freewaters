...
//        $mailer->registerPlugin(new \Swift_Plugins_LoggerPlugin($logger));
        ...
        $body .= '                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#00c1f7">';
        $body .= '                        <tr>';
        $body .= '                            <td style="padding:0;"><a href="https://www.facebook.com/freewatersphilippines/?sk=app_190322544333196&ref=s" target="_blank"><img src="https://' . $_SERVER['HTTP_HOST'] . '/images/step.jpg" width="100%" style="display:block;"></a></td>';
        $body .= '                        </tr>';
        $body .= '                    </table>';
        $body .= '                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">';
        $body .= '                        <tr>';
        $body .= '                            <td style="padding:20px 30px 30px; text-align: center;"><a href="https://www.facebook.com/freewatersphilippines/?sk=app_190322544333196&ref=s" target="_blank" style="display: inline-block; color:#ffffff; background: #3B579D; text-decoration: none; height: 40px; line-height: 40px; width: 200px;">Go to Facebook Fan Page</a></td>';
        $body .= '                        </tr>';
        $body .= '                    </table>';
        $body .= '                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#00c1f7">';
        $body .= '                        <tr>';
        ...
        $body .= '                                   <table>';
        $body .= '                                       <tr>';
        $body .= '                                           <td> <p style="color:#231f20; font-size: 15px; line-height:18px; mso-table-lspace:0; mso-table-rspace:0; margin:0; mso-line-height-rule:exactly;  font-weight:bold; text-align: left;">Just present this coupon upon <br> purchase on participating <br><span style="color:#ed1c24;">Res | Toe | Run</span> or <span style="color:#ed1c24;">R.O.X.</span> Outlet</p><p style="font-family: Arial, Helvetica, sans-serif; color:#231f20; font-size: 15px; line-height:18px; mso-table-lspace:0; mso-table-rspace:0; margin:15px 0 0; mso-line-height-rule:exactly;  font-weight:normal; text-align: left;">This coupon is only valid from <br><span style="color:#ed1c24;">12 August 2016</span> to <span style="color:#ed1c24;">30 September 2016</span>.</p>';
        $body .= '                                           </td>';
        $body .= '                                       </tr>';
        $body .= '                                   </table>';
        $body .= '                                </td>';
    ...
    public function sendRaffleMail($data)
    {
        ...
        $body .= '                                <p style = "font-family: Arial, Helvetica, sans-serif; color:#414042; font-size:15px; line-height: 18px; mso-table-lspace:0; mso-table-rspace:0; margin:0 0 10px 0; mso-line-height-rule:exactly; text-align:center; font-weight:normal;" > Not only that, here\'s another <span style="color:#ed1c24;">30% discount</span> when<br>you purchase any regular priced items at <span style="color:#ed1c24;">Res-Toe-Run <br>and R.O.X.</span> </p>';
        $body .= '                                <p style = "font-family: Arial, Helvetica, sans-serif; color:#414042; font-size:15px; line-height: 18px; mso-table-lspace:0; mso-table-rspace:0; margin:0 0 10px 0; mso-line-height-rule:exactly; text-align:center; font-weight:normal;" > This discount can only be applied to a separate purchase.</span> </p>';
        ...
        $body .= '                                           <td> <p style="font-family: Arial, Helvetica, sans-serif; color:#231f20; font-size: 15px; line-height:18px; mso-table-lspace:0; mso-table-rspace:0; margin:0; mso-line-height-rule:exactly;  font-weight:normal; text-align: left;">Just present this coupon upon <br> purchase on participating <br><span style="color:#ed1c24;">Res | Toe | Run</span> or <span style="color:#ed1c24;">R.O.X.</span> Outlet</p>
            <p style="font-family: Arial, Helvetica, sans-serif; color:#231f20; font-size: 15px; line-height:18px; mso-table-lspace:0; mso-table-rspace:0; margin:15px 0 0; mso-line-height-rule:exactly;  font-weight:normal; text-align: left;">This coupon is only valid from <br><span style="color:#ed1c24;">12 August 2016</span> to <span style="color:#ed1c24;">30 September 2016</span>.</p>';
        $body .= '                                           </td>';
        $body .= '                                       </tr>';
        $body .= '                                   </table>';
        $body .= '                                </td>';
