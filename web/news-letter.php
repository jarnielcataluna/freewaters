...
$body .= '                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">';
$body .= '                                    <tr>';
$body .= '                                        <td style="padding:0;"><img src="images/banner.jpg" alt="" width="100%" style=="display:block;"></td>';
$body .= '                                    </tr>';
$body .= '                                </table>';
$body .= '                                ';
$body .= '                            </td>';
...
$body .= '                        </tr>';
$body .= '                        <!-- <tr>';
$body .= '                            <td><img src="images/freewater-logo.jpg" alt="" width="100%" style="display:block;"></td>';
$body .= '                        </tr>';
$body .= '                        <tr>';
$body .= '                            <td>';
$body .= '                               <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#17b3f6">';
$body .= '                                   <tr>';
$body .= '                                       <td style="padding:0px 70px;"><img src="images/product1.jpg" alt=""></td>';
$body .= '                                   </tr>';
$body .= '                               </table> ';
$body .= '                            </td>';
$body .= '                        </tr> -->';
$body .= '                        <!-- <tr><td><img src="images/howto-join.jpg" alt="" width="100%" style="display:block;"></td></tr> -->';
$body .= '                    </table>';
$body .= '                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">';
$body .= '                        <tr>';
$body .= '                            <td><img src="images/product.jpg" width="100%" style="display:block;"></td>';
$body .= '                        </tr>';
$body .= '                        <tr>';
$body .= '                            <td align="center" style="text-align: center; max-width: 100%; padding: 5px 0;"><a href="https://www.facebook.com/" title="Go to our Facebook Fan Page"  target="_blank"><img src="images/step.jpg" width="auto" style="display:inline-block;" ></a></td>';
$body .= '                        </tr>';
$body .= '                        <tr>';
$body .= '                            <td align="center" style="text-align: center; max-width: 100%; padding: 5px 0;"><img src="images/freewater-img.jpg" width="100%"></td>';
$body .= '                        </tr>';
$body .= '                    </table>';
$body .= '                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">';
$body .= '                        <tr>';
...
$body .= '                                            <img src="images/res-toe-run.jpg" width="50%" style="display: inline-block; width:48%; vertical-align: top;" alt="">';
$body .= '                                            <img src="images/rox.jpg" width="50%" style="display: inline-block; width:48%; vertical-align: top;" alt="">';
$body .= '                                        </td>';
$body .= '                                    </tr>';
$body .= '                                    <tr>';
